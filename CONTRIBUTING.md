...
3. **Add upstream** remote:
   ```bash
   git remote add upstream https://github.com/YusufAbozeid/EduMind-AI.git
   ```
...
│   ├── src/modules/   # Feature modules (lesson, chat, curriculum)
...
│
└── edumind/           # Legacy Streamlit module
```
...
Not sure where to start? Here are some areas where we'd love help:
